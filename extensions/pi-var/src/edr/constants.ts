/**
 * EDR (Endpoint Detection and Response) constants
 */

/**
 * Known EDR/AV process names by platform
 */
export const EDR_PROCESSES: Record<string, string[]> = {
  darwin: [
...
export const EDR_INFO: Record<string, { product: string; knownSlowCoW: boolean }> = {
